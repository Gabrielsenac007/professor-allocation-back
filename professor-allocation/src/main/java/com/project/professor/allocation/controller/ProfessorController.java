...
public class ProfessorController {
    ...
    // metodo anterior que listava todos os professores sem paginação
    /*
    ...
    */
    ...
    @Operation(summary = "Pageable List Professors")
    @GetMapping(produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<List<Professor>> getPages(@RequestParam(defaultValue = "0") int page
            , @RequestParam(defaultValue = "5") int size) {
        Page<Professor> pageableList = professorService.findAllWithPages(page, size);
